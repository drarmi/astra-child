<?php
/**
 * Checkout shipping methods (standard WooCommerce markup, block layout).
 *
 * @package Astra Child
...
$calculator_text          = '';
?>
<div class="nova-checkout__shipping-package woocommerce-shipping-totals shipping" data-package-index="<?php echo esc_attr( (string) $index ); ?>">
