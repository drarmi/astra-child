<?php
/**
 * CartFlows shipping methods — title rendered in nova-checkout section header.
 *
 * @package Astra Child
 * @see wp-content/plugins/cartflows/modules/checkout/templates/checkout/shipping-methods.php
 */
